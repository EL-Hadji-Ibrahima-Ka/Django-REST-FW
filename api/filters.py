...
class EmpruntFilter(django_filters.FilterSet):
    ...
    date_emprunt_min = django_filters.DateFilter(field_name='date_emprunt', lookup_expr='gte')
    date_emprunt_max = django_filters.DateFilter(field_name='date_emprunt', lookup_expr='lte')
